  ...
  return (
    <article id="about" className="about w-screen">
      <section className="w-screen text-xl flex flex-col justify-start items-center">
        ...
        <p className="mt-5 w-1/2">I&apos; a web developer with an appetite for problem solving and challenge. My goal is to write clean code and ship performant quality software.
